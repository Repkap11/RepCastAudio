package com.repkap11.repcastaudio.services;
...
public class ServiceNotifications extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        boolean notificationsEnabled = RCAApplication.getUserPerferedNotoficationsEnabled(this);
        RCAApplication.setNewToken(this, notificationsEnabled, token);
    }
